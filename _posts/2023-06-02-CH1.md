...
- 루트 계정으로 로그인하여 [링크](https://us-east-1.console.aws.amazon.com/iamv2/home#/users){:target="_parent"}에 클릭하여 IAM 사용자 페이지에 진입합니다.
- `사용자 추가` 버튼을 클릭합니다.
