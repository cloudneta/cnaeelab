...
|[&nbsp;&nbsp;&nbsp;&nbsp;2.2 Amazon EKS 노드 생성 (관리 콘솔)](#21-amazon-eks-노드-생성-관리-콘솔)|
|[&nbsp;&nbsp;&nbsp;&nbsp;2.3 Amazon EKS 노드 삭제 (관리 콘솔)](#21-amazon-eks-노드-삭제-관리-콘솔)|
...
<details>
<summary>eksctl 사용 연습(배포 없이)</summary>
<div markdown="1">

{% highlight javascript linenos %}
// EKS 클러스터 노드 그룹 없이 생성
