...
이번 실습은 IAM 사용자 계정을 통해 관리 콘솔에 접근하고 엑세스 키를 활용해 awscli 도구를 사용합니다.  
해당 작업을 수행하지 않았다면 아래 토글을 확장해 작업을 선행하고 본격적인 실습에 들어갑니다.

<details>
<summary>IAM 사용자 생성 및 엑세스 키 생성</summary>
<div markdown="1">
...
{: .box-warning}
**Warning:** 실습의 편의를 위해 루트 계정에서 엑세스 키 생성했지만 현업에서는 보안 상 IAM 사용자에서 엑세스 키를 생성하는 것을 권장합니다.
