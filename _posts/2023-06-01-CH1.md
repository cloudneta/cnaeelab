...
<span style='color:white; background-color:black'> **사용자 확인** </span>
...
<span style='color:white; background-color:black'> **기본 설치 도구 확인** </span>

{% highlight javascript linenos %}{% endhighlight %}
