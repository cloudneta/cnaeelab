...
- Name: Mimir  
- Connection - Prometheus server URL: **<span style="color:red; border: 1px solid gray; padding: 1px;">http://mimir-nginx.monitoring/prometheus</span>**  
- Save & Test
...
- Name: Loki  
- Connection - Loki server URL: **<span style="color:red; border: 1px solid gray; padding: 1px;">http://loki-loki-distributed-gateway.logging</span>**  
- Save & Test
...
- Name: Tempo  
- Connection - Tempo server URL: **<span style="color:red; border: 1px solid gray; padding: 1px;">http://tempo-query-frontend-discovery.tracing:3100</span>**  
- Save & Test
