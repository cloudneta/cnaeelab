...
{: .box-note}
**Note:** https://kubecost.도메인주소로 접속합니다.
...
{: .box-note}
**Note:** https://opencost.도메인주소로 접속합니다.
...
{% highlight javascript linenos %}
// 네임스페이스 단위로 5분간 비용 확인 (Efficiency 항목 추가)
...
kubectl delete statefulset grafana-agent -n kubecost
kubectl delete service grafana-agent -n kubecost
{% endhighlight %}
