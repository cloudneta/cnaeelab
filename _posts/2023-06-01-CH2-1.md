...
<span style='color:white; background-color:#5865F2'>**Amazon EKS 원클릭 배포**</span>를 통해 실습 구성의 시간 절약과 함께 각 실습의 목표 학습 내용만 집중할 수 있을 것입니다.
...
{: .box-warning}
**Warning:** 설정을 마치고 약 20분 정도 대기 시간이 흐른 뒤 기본 인프라 환경과 Amazon EKS 클러스터 생성이 완료됩니다.  
반드시 해당 대기 시간이 지난 후 다음 작업을 수행합니다.
