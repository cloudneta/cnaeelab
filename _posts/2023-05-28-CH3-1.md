...
ssh ec2-user@$N3 tail -f /opt/local-path-provisioner/${LP_PVC_NAME}_default_localpath-claim/out.txt
{% endhighlight %}

<br/>

{: .box-note}
**Note:** PV에서 Node Affinity로 지정된 노드에 따라 N3가 아닌 다른 대상일 수 있습니다.
